...
export const Route = createFileRoute("/admin-login")({
  ...
  head: () => ({
    meta: [
      { title: "Admin Sign In — CloudCart POS" },
      {
        name: "description",
        content:
          "Admin sign in for CloudCart using a username and password assigned by the platform administrator.",
      },
      { property: "og:title", content: "Admin Sign In — CloudCart POS" },
      {
        property: "og:description",
        content: "Access the CloudCart admin dashboard with your administrator username and password.",
      },
      ...
      <div className="w-full max-w-sm rounded-3xl border border-border bg-card p-6 shadow-lift">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Username and password only. Shop and cashier logins use their own sign-in pages.
          </p>
        </div>
